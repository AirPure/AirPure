...
char mqttPass[] = "XXXXXX"; //chave de acesso do MQTT.
char writeAPIKey[] = "XXXXXXX"; //chave de escrita, canal Thingspeak.
long channelID = 000000; //Identificação do canal Thingspeak - Pessoal.
