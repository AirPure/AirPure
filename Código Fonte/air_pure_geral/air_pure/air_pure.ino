...
char mqttPass[] = "XXXX"; //chave de acesso do MQTT.
char writeAPIKey[] = "XXXX"; //chave de escrita, canal Thingspeak.
long channelID = 00000; //Identificação do canal Thingspeak - Pessoal.
