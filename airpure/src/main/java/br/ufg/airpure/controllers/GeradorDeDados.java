    ...
    public void aviso() throws MalformedURLException, IOException, AddressException, MessagingException, InterruptedException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                amostragens amostra = new amostragens();
                ambientes ambiente = new ambientes();
                rangeParametros r = new rangeParametros();
                ...
                amostra.setLux(rs.getFloat("lux"));
                amostra.setDb(rs.getFloat("db"));
                r.setCo2(rs.getBoolean("co2"));
                r.setEco2(rs.getBoolean("eco2"));
                r.setTvoc(rs.getBoolean("tvoc"));
                r.setLuminosidade(rs.getBoolean("luminosidade"));
                r.setRuido(rs.getBoolean("ruido"));
                r.setTemperatura(rs.getBoolean("temperatura"));
                r.setUmidade(rs.getBoolean("umidade"));
                amostra.setTemperatura(rs.getFloat("temperatura"));
                amostra.setUmidade(rs.getFloat("umidade"));
                ...
                if (amostra.getUmidade() > process.getMaxUMIDADE() && r.isUmidade()) {
                ...
                if (amostra.getDb() > process.getMaxRUIDO() && r.isRuido()) {
                ...
                if (amostra.getLux() > process.getMaxLUMINOSIDADE() && r.isLuminosidade()) {
